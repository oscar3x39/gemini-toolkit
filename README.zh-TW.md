...
- **刪除中可中止** — 長批次隨時喊停。
- **閱讀模式** — 左下「閱讀」鈕一鍵切換:字級/行距對照 Medium:正文 20px / 1.8 行距、內容欄預設滿版(一屏看更多行)、段距 1.2em、標題留白、行內 code 提高對比、改用系統字體(PingFang),輸入框壓扁。右鍵該鈕可調寬度(滿版 / 1400 / 1100 / 760)/字級(18–24)/字體(系統 / Google Sans / 宋體),設定會記住。
